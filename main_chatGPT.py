...
def save_to_json(json_file, pmid_dict):
    ...
    Receives a text file containing 10 article titles and generates a JSON file with a dictionary containing the PMID number.
    :return: no return
    '''
...
def main():
    ...
    # initializations
    titles, driver, pmid_dict = initialize('titles.txt')
